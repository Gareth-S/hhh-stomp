...
and also emit a companion .json metadata file.
...
def render_burger_menu(f) -> None:
    ...
    print('                    <a href="../setlists.html">Set Lists</a>', file=f)
...
def render_footer(f) -> None:
    ...
    print(file=f)
    print("            </nav>", file=f)
    print('                <p align="center"> <small>HhH 2026 - v0.7</small></p>', file=f)
    print(file=f)
    print("        </footer>", file=f)
    print(file=f)
...
def main() -> None:
    ...
    # Output names: spaces → underscores, same directory as input
